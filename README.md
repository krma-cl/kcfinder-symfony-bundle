...
The bundle does not copy or publish the legacy browser automatically. Follow the [core installation guide](https://github.com/krma-cl/kcfinder-Resurrected#installation) for the browser itself.
